...
local MATH_ENVIRONMENTS = { displaymath = true, equation = true, eqnarray = true, align = true, math = true, array = true, aligned = true }
...
local function in_markdown_mathzone()
  ...
  while node do
    ...
    local t = node:type()
    if t == "math_inline" or t == "math_block" or t == "dollar_math" or t == "dollar_dollar_math" or t == "inline_formula" or t == "displayed_equation" then
      return true
    end
    node = node:parent()
  end
